...
# RUN huggingface-cli download SG161222/Realistic_Vision_V5.1_noVAE --repo-type model --local-dir /workspace/ComfyUI/models/checkpoints/ --local-dir-use-symlinks False
